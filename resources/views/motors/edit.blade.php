    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 font-weight-bold text-dark mb-0">
                <i class="bi bi-pencil-square me-2"></i>{{ __('Edit Motor') }}
            </h2>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="brand" id="brand" class="form-control rounded-3"
                                        placeholder="Merk" value="{{ $motor->brand }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="model" id="model" class="form-control rounded-3"
                                        placeholder="Model" value="{{ $motor->model }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" name="year" id="year" class="form-control rounded-3"
                                        placeholder="Tahun" value="{{ $motor->year }}" min="1900"
                                        max="{{ date('Y') + 1 }}">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <select class="form-select rounded-3" name="status" id="status">
                                        <option value="available" {{ $motor->status == 'available' ? 'selected' : '' }}>
                                            Tersedia</option>
                                        <option value="borrowed" {{ $motor->status == 'borrowed' ? 'selected' : '' }}>
                                            Dipinjam</option>
                                    </select>
